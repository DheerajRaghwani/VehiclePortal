...
form.addEventListener("submit", async (e) => {
	...
	try {
		...
		let roleFromResponse =
			data.role && typeof data.role === "string" ? data.role : null;
		...
		if (role === "admin") {
			...
			let districtFromResponse =
				data.districtName && typeof data.districtName === "string"
					? data.districtName
					: null;
			let district =
				districtFromResponse || extractDistrictFromJwt(data.token) || "Unknown";
