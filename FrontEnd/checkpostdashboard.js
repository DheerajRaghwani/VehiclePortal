const apiUrl = "https://localhost:7005/api/CheckpostDashboard";
...
async function loadDashboardData() {
    ...
    try {
        ...
        displayOverallPeople(result.overallPeople); // Overall total
        displayDistrictData(result.districtData);   // District-wise data
